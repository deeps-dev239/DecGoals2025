...
public class AdvancedSettingsPage extends BasePage {
    ...
    private By operationName= By.xpath("//mat-label[text()='Operation Name']/ancestor::span/..//input");
    private By operationID= By.xpath("//mat-label[text()='Operation ID']/ancestor::span/..//input");
    private By desc= By.xpath("//mat-label[text()='Description']/ancestor::span/..//input");
    ...
    public void createAdvanceSettings() {
        ...
        // selectFromMatDropdown(tax, "Cgst2.5%Sgst2.5%Zen");
