...
public class ServiceCategoriesSearchPage extends BasePage {
    ...
    private By serviceCategoriesNav =
    ...
    public ServiceCategoriesSearchPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
    ...
    public void clickFXSPAConfigIcon() {
        ...
        // ensure driver is on main window
        for (String handle : driver.getWindowHandles()) {
            driver.switchTo().window(handle);
        }

        WebElement fx =
                wait.until(ExpectedConditions.presenceOfElementLocated(fxSPAConfigIcon));
    ...
    public void clickServiceCategories() {
        ...
        WebElement category =
                wait.until(ExpectedConditions.elementToBeClickable(serviceCategoriesNav));
